...
- (void)xmppStream:(XMPPStream *)sender didReceivePresence:(XMPPPresence *)presence
{
	...
	if ([[presence type] isEqualToString:@"subscribe"])
	{
        ...
        NSLog(@"XMPPRoster===check existance %@",[xmppStream description]);
        NSLog(@"XMPPRoster===check existance %hhd",[xmppRosterStorage userExistsWithJID:userJID xmppStream:xmppStream]);
