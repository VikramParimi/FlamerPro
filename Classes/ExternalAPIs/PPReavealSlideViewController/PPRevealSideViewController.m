...
- (void) gestureRecognizerDidPan:(UIPanGestureRecognizer*)panGesture {
    ...
    */
    ...
    //Updated By Sanskar
    if (_currentPanDirection == PPRevealSideDirectionLeft) {
        CGRect frameSideView = c.view.frame;
        frameSideView.origin.x = self.rootViewController.view.frame.origin.x - ScreenSize.width;
        c.view.frame = frameSideView;
    }
...
//            }
        ...
        else
        {
            ...
            if ([self.delegate respondsToSelector:@selector(pprevealSideViewController:swipedToNewController:WithDirection:)]) {
                [self.delegate pprevealSideViewController:self swipedToNewController:c WithDirection:_currentPanDirection];
            }
            
            
           // UINavigationController *navVC = [[UINavigationController alloc]initWithRootViewController:c];
