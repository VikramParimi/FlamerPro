 ...
 */
@property (nonatomic, retain) id <PPRevealSideViewControllerDelegate> delegate;
...
-(void)pprevealSideViewController:(PPRevealSideViewController *)controller swipedToNewController:(UIViewController *)newCenterController WithDirection:(int)PPRevealSideDirection;
